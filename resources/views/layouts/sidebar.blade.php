            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @if (auth()->user()->role == 1)
                    ...
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ 'produk' == request()->path() || 'pembelian' == request()->path() ? 'hover show active' : '' }}">
                        ...
                        <div class="menu-sub menu-sub-accordion{{ 'produk' == request()->path() || 'pembelian' == request()->path() ? ' show' : '' }}"
                            {{ 'produk' == request()->path() || 'pembelian' == request()->path() ? 'style=display: none; overflow: hidden;' : 'style=flex=0;' }}>
                            <div class="menu-item">
                ...
                @endif
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ 'penjualan' == request()->path() || 'kasir' == request()->path() ? 'hover show active' : '' }}">
                    <span class="menu-link ">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                            <span class="svg-icon svg-icon-2">
